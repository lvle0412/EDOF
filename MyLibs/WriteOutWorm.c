...
*/						
		...
		if (Params->PhasePlaneAnalyzeOn && Params->OnOff){
			cvWriteReal(fs,"PhaseSpaceMode_t1",(double) *(Worm->TimeEvolution->currPhaseSpaceModes));
			cvWriteReal(fs,"PhaseSpaceMode_t3",(double) *(Worm->TimeEvolution->currPhaseSpaceModes+1));
			cvWriteReal(fs,"PhaseSpaceMode_f1",(double) *(Worm->TimeEvolution->currPhaseSpaceModes+2));
			cvWriteReal(fs,"PhaseSpaceMode_f2",(double) *(Worm->TimeEvolution->currPhaseSpaceModes+3));
			cvWriteReal(fs,"PhaseSpaceMode_t2",(double) *(Worm->TimeEvolution->currPhaseSpaceModes+4));
			cvWriteReal(fs,"PhaseSpaceMode_r1",(double) *(Worm->TimeEvolution->currPhaseSpaceModes+5));
			cvWriteReal(fs,"PhaseSpaceMode_r2",(double) *(Worm->TimeEvolution->currPhaseSpaceModes+6));		
		}
